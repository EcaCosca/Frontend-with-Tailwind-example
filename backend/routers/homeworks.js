...
router.get("/", async (req, res) => {
  const data = JSON.parse(await fs.readFile("data/homeworks.json", "utf-8"));
...
router.post("/", async (req, res) => {
  ...
  await fs.writeFile("data/homeworks.json", JSON.stringify(data));
...
router.put("/:id", async (req, res) => {
  ...
  console.log(data);
  let result = await fs.writeFile("data/homeworks.json", JSON.stringify(data));
  console.log(result);
...
router.delete("/:id", async (req, res) => {
  ...
  await fs.writeFile("data/homeworks.json", JSON.stringify(newData));
